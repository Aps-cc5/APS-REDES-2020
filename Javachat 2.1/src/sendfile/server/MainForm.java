...
public class MainForm extends javax.swing.JFrame {
        ...
        for(int x=0; x < clientFileSharingUsername.size(); x++){
            if(clientFileSharingUsername.elementAt(x).equals(username)){
                try {
                    ...
                    appendMessage("[FileSharing]: Cancelar "+ username);
                } catch (IOException e) {
                    appendMessage("[FileSharing]: "+ e.getMessage());
                    appendMessage("[FileSharing]: Não é possível cancelar "+ username);
                }
                break;
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sendfile/server/logo-qchat-app-1.png"))); // NOI18N

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("Servidor SEMA Chat");

        jLabel1.setText("Port:");

        jTextField1.setText("4444");

        jButton1.setText("Iniciar o servidor");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Bortolo\\Desktop\\Javachat-2.0-master\\Javachat 2.1\\src\\images\\logo-sema.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        int confirm = JOptionPane.showConfirmDialog(null, "Feche o servidor?");
        if(confirm == 0){
            serverThread.stop();
        }
