...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\Bortolo\\Desktop\\Javachat-2.0-master\\Javachat 2.1\\src\\images\\logo-sema.png")); // NOI18N
    ...
    private void connectToServer(){
        if(txtHost.getText().length() > 0 && txtPort.getText().length() > 0 && txtUsername.getText().length() > 0){
            if(txtUsername.getText().length() <= 15){
                ...
                JOptionPane.showMessageDialog(this, "A conta deve ter no máximo 15 caracteres, incluindo [espaço].!", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        } else {
